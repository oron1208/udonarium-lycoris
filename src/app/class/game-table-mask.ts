...
export class GameTableMask extends TabletopObject {
  ...
  @SyncVar() maskType: string = 'normal';
  @SyncVar() lightShape: string = 'rect';
  @SyncVar() lightAngle: number = 0;
  @SyncVar() lightArc: number = 90;
  @SyncVar() attachedCharacterIdentifier: string = '';
...
//  @SyncVar() isScratchPreviewOnGMMode = false;
  ...
  @SyncVar() isLightweight: boolean = false;
  ...
  get isLightReactiveMask(): boolean { return this.maskType === 'lightReactive'; }
  get isLightAreaMask(): boolean { return this.maskType === 'lightArea'; }
